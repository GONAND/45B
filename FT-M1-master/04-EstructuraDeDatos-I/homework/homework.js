...
function nFibonacci(n) {
  ...
  let resultado = nFibonacci(n - 1) + nFibonacci(n - 2);
  return resultado;
}
...
Queue.prototype.dequeue = function () {
  if (this.fila.size === 0) return undefined;
  this.fila.shift();
  return this.fila;
};
...
Queue.prototype.changeFirstElement = function (arg) {
  this.fila.shift();
  this.fila.unshift(arg);
  return this.fila;
};

Queue.prototype.changeLastElement = function (arg) {
  this.fila.pop();
  this.fila.push(arg);
  return this.fila;
};
...
console.log(newQueue.enqueue("Nina"));
console.log(newQueue.enqueue("Jose"));
console.log(newQueue.enqueue("Sergio"));
console.log(newQueue.dequeue());
console.log(newQueue.enqueue("Daniel"));
console.log(newQueue.size());
console.log(newQueue.changeFirstElement("Nina"));
console.log(newQueue.changeLastElement("Israel"));
